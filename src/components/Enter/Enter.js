...
class Enter extends React.Component {
    ...
    render() {
        return (
            <div className="Enter">
                <SectionHeader headerText="Вход в Личный кабинет" />

                <form onSubmit={this.submitHandler}>
                    { this.renderInputs() }

                    {this.state.showAuthError
                        ? <p className="enterErrorMessage">Неправильный логин или пароль</p>
                        : null
                    }

                    <Button title="Войти" type="button" disabled={!this.state.isFormValid} onClick={this.validateControls} />
                </form>
            </div>
        )
    }
